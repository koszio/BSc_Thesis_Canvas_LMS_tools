...
def extract_thesis_info_pdf(authors, url)
  puts "-----------------------------------------------------"
  result = `cd ../connecting_silos/connecting_silos_kththesis_TCOMK_CINTE/polls/src && sudo python parsingPDF.py /home/maguire/connecting_silos/connecting_silos_kththesis_TCOMK_CINTE/polls/src/Samuel_and_Emma.pdf`
  thesis_info_json_path = "/home/maguire/connecting_silos/connecting_silos_kththesis_TCOMK_CINTE/polls/output/parse_result" + result[/#{"parse_result"}(.*?)#{"output.json"}/m, 1] + "output.json"
 # thesis_info_json_path = "/home/maguire/connecting_silos/connecting_silos_kththesis_TCOMK_CINTE/polls/output/parse_result/_maria touranakou_9cc21546-25ac-11ea-a7bc-080027b3a760_2019-12-23 18:49:48.279035/output.json"
  thesis_info_json = File.read(thesis_info_json_path)
  thesis_info = JSON.parse(thesis_info_json)
...
def get_kth_author_info(kthid)
  author_profile_temp = {
    'username' => 'ann',
    'firstName' => 'Ann',
    'lastName' => 'FakeStudent',
    'organisation' => {
       'L1': 'School of Information and Communication Technology (ICT)',
       'L2': 'Communication Systems, CoS'
   }
  }
  return JSON[author_profile_temp]
end 

def get_kth_examiner_info(kthid)
  author_profile_temp = {
    'username' => 'anves',
    'firstName' => 'Anders',
    'lastName' => 'Vestberg',
...
def get_kth_supervisor_info(kthid)
  author_profile_temp = {
    'username' => 'maguire',
    'firstName' => 'Gerald',
    'lastName' => 'Q.Maguire Jr',
    'title' => {
      'en' => 'Professor'
    },
    'researcher' => {
...
get "/prepareAnnouncementStep2" do
  ...
  @thesis_info_en_abstract=@thesis_info['abstract(en)']
  @thesis_info_en_keywords=@thesis_info['keywords(en)']
  @thesis_info_sv_abstract=@thesis_info['abstract(sv)']
  @thesis_info_sv_keywords=@thesis_info['keywords(sv)']
...
post "/approveThesisStep1" do
  ...
  author_profile=JSON.parse(get_kth_author_info(author_info['sis_user_id']))
  ...
  diva_thesis_info['Author1']={"Last name": author_profile['lastName'], 	# from KTH user's profile
				...
				"organisation": author_profile['organisation']
  ...
  examiner_profile=JSON.parse(get_kth_examiner_info(examiner_sis_user_id))
  ...
  if examiner_profile and not examiner_profile["username"]
    ...
    diva_thesis_info['Examiner1']={"Last name": examiner_profile['lastName'], 	# from KTH user's profile
	                           ...
	                           "ORCiD": examiner_profile['researcher']['orcid'],
                                   #"organisation": get_kth_organization_info(examiner_profile)	
				   "organisation": examiner_profile['organisation']
# {"L1": "School of Information and Communication Technology (ICT)",
                                    #  "L2": "Communication Systems, CoS",
                                    #  "L3": "Radio Systems Laboratory (RS Lab)"}
                                  }
  ...
  supervisor_sis_user_ids.each do |s|
    supervisor_profile=JSON.parse(get_kth_supervisor_info(s))
    ...
    if supervisor_profile and not supervisor_profile["username"]
      ...
      diva_thesis_info[s_index]={"Last name": supervisor_profile['lastName'], 	# from KTH user's profile
				...
				"organisation": supervisor_profile['organisation']
...
diva_thesis_info['Title']={'Main title': @thesis_info['title'],
 ...
 # diva_thesis_info['Other information']={'Number of pages': @thesis_info['pages'], 'Year': year_of_thesis}
  ...
  diva_thesis_info['Other information']={'Number of pages': "50", 'Year': year_of_thesis}
  ...
  diva_thesis_info['Abstract1']={'Abstract': @thesis_info['abstract(en)'], 'Language': 'eng'}

  diva_thesis_info['Keywords1']={'Keywords': @thesis_info['keywords(en)'], 'Language': 'eng'}

  diva_thesis_info['Abstract2']={'Abstract': @thesis_info['abstract(sv)'], 'Language': 'swe'}

  diva_thesis_info['Keywords1']={'Keywords': @thesis_info['keywords(sv)'], 'Language': 'swe'}
  ...
  if result.length > 0
    ...
    if attachments
      attachments.each do |attachment|
        ...
        session['resulting_file_name'] = resulting_file_name
	...
	<body >
        ...
        <form action="/sendToDiVA" method="GET"><input type="submit" value="Send to DiVA"/></form>
      </body >
   </html > 
   HTML
...
get "/sendToDiVA" do
  `cd ../Diva/ && node diva7.js ../utils/#{session['resulting_file_name']}`
end
